...
def train_cd(
    ...
    for epoch in range(n_epochs):
        ...
        E_data_epoch, E_model_epoch, E_diff_epoch, mse_epoch, loss_epoch = (
            0.0,
            0.0,
            0.0,
            0.0,
        ...
        for _, batch_data in enumerate(train_loader):
            ...
            E_data, E_model, E_diff, mse, loss = model.contrastive_divergence(
                X_train, pcd, mc, k, epsilon, lr, weight_decay, momentum
            )
...
def train_sm(
    ...
    Parameters pcd, mc, k, and epsilon in training_cfg are only for diagnosis metrics calculation
